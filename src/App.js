          ...
          <div className="container-fluid ">
            <div>
              <div className="row">
                ...
                <div class="col-2 border-right-gray ">
                  <div className="row flex-column ">
                    {(partnerTypeUser === undefined) ? ""
                      : <Link to="/" className=" nav-item-h mt-2">
